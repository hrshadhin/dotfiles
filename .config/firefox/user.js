...
user_pref("browser.newtabpage.activity-stream.discoverystream.rec.impressions", "{\"92272\":1620473058087,\"92491\":1620473058087,\"92557\":1620473058086}");
user_pref("browser.newtabpage.activity-stream.feeds.section.highlights", false);
user_pref("browser.newtabpage.activity-stream.feeds.topsites", false);
user_pref("browser.newtabpage.activity-stream.impressionId", "{a8d1a806-2f56-4dfa-8089-5e3e0610f7d5}");
user_pref("browser.newtabpage.activity-stream.showSearch", false);
user_pref("browser.newtabpage.storageVersion", 1);
user_pref("browser.pageActions.persistedActions", "{\"ids\":[\"bookmark\",\"pinTab\",\"bookmarkSeparator\",\"copyURL\",\"emailLink\",\"addSearchEngine\",\"sendToDevice\"],\"idsInUrlbar\":[\"bookmark\"],\"version\":1}");
user_pref("browser.pagethumbnails.storage_version", 3);
user_pref("browser.protections_panel.infoMessage.seen", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1620495164026");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1620496960026");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1620494656396");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1620516256396");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210504152106");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1620496150");
user_pref("browser.startup.homepage", "http://tablero.test");
user_pref("browser.startup.homepage_override.mstone", "88.0.1");
user_pref("browser.startup.lastColdStartupCheck", 1620496150);
user_pref("browser.tabs.drawInTitlebar", false);
user_pref("browser.tabs.warnOnClose", false);
user_pref("browser.toolbars.bookmarks.visibility", "never");
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"home-button\",\"urlbar-container\",\"downloads-button\",\"library-button\",\"sidebar-button\",\"fxa-toolbar-menu-button\",\"_contain-facebook-browser-action\",\"_testpilot-containers-browser-action\",\"jid1-mnnxcxisbpnsxq_jetpack-browser-action\",\"_446900e4-71c2-419f-a6a7-df9c091e268b_-browser-action\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"PersonalToolbar\":[\"personal-bookmarks\"]},\"seen\":[\"developer-button\",\"_contain-facebook-browser-action\",\"_testpilot-containers-browser-action\",\"jid1-mnnxcxisbpnsxq_jetpack-browser-action\",\"_446900e4-71c2-419f-a6a7-df9c091e268b_-browser-action\"],\"dirtyAreaCache\":[\"nav-bar\",\"PersonalToolbar\",\"toolbar-menubar\",\"TabsToolbar\"],\"currentVersion\":18,\"newElementCount\":6}");
...
user_pref("doh-rollout.disable-heuristics", false);
user_pref("doh-rollout.doneFirstRun", false);
user_pref("dom.forms.autocomplete.formautofill", true);
user_pref("dom.push.userAgentID", "7579bb0353db45aeb17ff78aec274f68");
user_pref("dom.security.https_only_mode", true);
user_pref("dom.security.https_only_mode_ever_enabled", true);
user_pref("fission.experiment.max-origins.last-disqualified", 0);
user_pref("fission.experiment.max-origins.last-qualified", 1620473046);
user_pref("fission.experiment.max-origins.qualified", true);
user_pref("font.language.group", "x-beng");
user_pref("font.name.monospace.x-beng", "Nikosh");
user_pref("font.name.sans-serif.x-beng", "Nikosh");
user_pref("font.name.serif.x-beng", "Nikosh");
user_pref("font.name.serif.x-unicode", "Hack");
user_pref("font.size.monospace.x-beng", 14);
user_pref("idle.lastDailyNotification", 1620494221);
user_pref("media.autoplay.default", 5);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1620474382);
user_pref("media.gmp-gmpopenh264.version", "1.8.1.1");
user_pref("media.gmp-manager.buildID", "20210504152106");
user_pref("media.gmp-manager.lastCheck", 1620474486);
...
user_pref("places.database.lastMaintenance", 1620494221);
...
user_pref("security.sandbox.content.tempDirSuffix", "13ca1230-5c74-4548-827b-b66bcdeafefe");
user_pref("security.sandbox.plugin.tempDirSuffix", "e586113b-a0cb-4ec3-b6c1-bb11db10a6ed");
user_pref("services.blocklist.addons-mlbf.checked", 1620491532);
user_pref("services.blocklist.gfx.checked", 1620491532);
user_pref("services.blocklist.plugins.checked", 1620491532);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1620485838409\"");
user_pref("services.settings.last_update_seconds", 1620491532);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1620491532);
user_pref("services.settings.main.cfr-fxa.last_check", 1620491532);
user_pref("services.settings.main.cfr.last_check", 1620491532);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1620491532);
user_pref("services.settings.main.hijack-blocklists.last_check", 1620491532);
user_pref("services.settings.main.language-dictionaries.last_check", 1620491532);
user_pref("services.settings.main.message-groups.last_check", 1620491532);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1620491532);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1620491532);
user_pref("services.settings.main.password-recipes.last_check", 1620491532);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1620491532);
user_pref("services.settings.main.search-config.last_check", 1620491532);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1620491532);
user_pref("services.settings.main.search-telemetry.last_check", 1620491532);
user_pref("services.settings.main.sites-classification.last_check", 1620491532);
user_pref("services.settings.main.tippytop.last_check", 1620491532);
user_pref("services.settings.main.top-sites.last_check", 1620491532);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1620491532);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1620491532);
user_pref("services.settings.main.whats-new-panel.last_check", 1620491532);
...
user_pref("storage.vacuum.last.places.sqlite", 1620494221);
user_pref("toolkit.startup.last_success", 1620496149);
user_pref("toolkit.telemetry.cachedClientID", "3c056508-f55a-4611-8edc-48f4d16fd1c5");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1620474381);
user_pref("extensions.getAddons.databaseSchema", 6);
user_pref("extensions.incognito.migrated", true);
user_pref("extensions.lastAppBuildId", "20211020161635");
...
user_pref("extensions.webextensions.restrictedDomains", "");
user_pref("extensions.webextensions.uuids", "{\"doh-rollout@mozilla.org\":\"1ce10761-731d-4744-9966-0c03a38a9dbd\",\"formautofill@mozilla.org\":\"f7773656-08c2-4b79-89d6-e497e87b0ac0\",\"pictureinpicture@mozilla.org\":\"9f440f21-8842-457f-9641-27df89374abb\",\"screenshots@mozilla.org\":\"f9a91afd-5d60-461d-9ce2-b94e9bf959e0\",\"webcompat-reporter@mozilla.org\":\"9178b5cb-1e26-455e-b7db-ef3ed451aef5\",\"webcompat@mozilla.org\":\"2e6522dd-c58f-4a8c-a735-c04b8521e4a2\",\"default-theme@mozilla.org\":\"d7b4716d-76ab-4631-8603-44513c3bdff7\",\"addons-search-detection@mozilla.com\":\"6be54910-3175-44a5-b15a-d15782a4ee97\",\"ddg@search.mozilla.org\":\"be570ad1-5f90-4ebb-93a2-30e22b22d4a8\",\"jid1-MnnxcxisBPnSXQ@jetpack\":\"ebb674cf-a157-4bc9-807e-b0a4ff486623\",\"firefox-compact-dark@mozilla.org\":\"8da6df6b-151a-4504-aeeb-7f2275098bf0\",\"{446900e4-71c2-419f-a6a7-df9c091e268b}\":\"6c2b8373-94b9-4125-a75e-0dac5b4c61d8\",\"@testpilot-containers\":\"eedebc10-22a4-4e8b-817d-91e91a6de0ee\",\"@contain-facebook\":\"4c38ca1a-0440-4a0b-a0ec-527aee0a8d7a\"}");
